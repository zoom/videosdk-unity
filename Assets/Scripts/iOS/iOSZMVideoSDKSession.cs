...
public class IOSZMVideoSDKSession
{
    private IntPtr objC_ZMVideoSDKSession;

    public IOSZMVideoSDKSession(IntPtr _objC_ZMVideoSDKSession)
    {
    ...
    public ZMVideoSDKUser GetSessionHost()
    {
        ...
        return new ZMVideoSDKUser(new IOSZMVideoSDKUser(objC_ZMVideoSDKUser));
    }
